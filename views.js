var GUI = (function() { //IIFE for all Views
  ...
  // changed objbect
  //-if/else statement that makes it so "assigned" === the user who logs in takes on
  //the project
  //-if/else statement that makes it so "done" === makes task disapear
  //if/else statement that makes it so  "unassigned" === pushes task to "unassigned"
  //view
  //////////////////////////////////////////////////////////////////////////////
  ...
  // -Creates a view that you can create a task in once you click the "Create Task"
  //btn
  //-The "save" function pushed the created task to the "UnassignedTasksView"
    ...
    render: function() {
      ...
      for (var i = 0; i < app.tasks.length; i++) {
        if (app.tasks.at(i).get("status") === 'unassigned') {
          var taskView1 = new TaskView({
            "model": app.tasks.at(i),
            "index": i,
            parent: this
          });
